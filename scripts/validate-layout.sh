...
need "bootstrap/ansible/README.md"
need "bootstrap/ansible/playbooks/greenfield.yml"
need "bootstrap/ansible/playbooks/join.yml"
need "bootstrap/ansible/playbooks/verify.yml"
need "apps/doco-cd/README.md"
